...
function CargaDeColor({funcionCargaDeColor}) {
    ...
    return <>
        ...
        <div className="d-flex justify-content-end">
            <button className="btn btn-info text-light my-2 me-2" type="submit" form="formularioDeCarga" onClick={() => funcionCargaDeColor(inputColor)}>Guardar</button>
        </div>
    </>
};
